...
public sealed class SoundManager
{
    ...
    public SoundManager()
    {
        ...
        _explosionLargePool = CreatePool(() => SoundGenerator.GenerateNoiseBurst(0.5, 0.55, 300));
        _explosionMediumPool = CreatePool(() => SoundGenerator.GenerateNoiseBurst(0.35, 0.55, 600));
        _explosionSmallPool = CreatePool(() => SoundGenerator.GenerateNoiseBurst(0.22, 0.55, 1200));
